...
public class FDAPDPPage extends BasePage {
    ...
    // TODO: Not verified against live DOM — standard Magento "product attribute sku" block pattern.
    private static final By PRODUCT_SKU         = By.xpath(
        "//div[contains(@class,'product') and contains(@class,'attribute') and contains(@class,'sku')]//div[@class='value'] | " +
        "//*[@itemprop='sku']");
